...
ax[0].set_title('SAGE')
ax[1].set_title('$d$-SAGE')
ax[0], std_sage = convergence_plot(sage, top=3, ax=ax[0], legend=False, time_axis=True)
ax[1], std_sage2 = convergence_plot(sage, top=3, ax=ax[1], time_axis=True)
