...
# load data # TODO: csv as command line arg or similar
...
while orderings_count < orderings:
    # TODO (cl): Either randomly sampled perturbations OR saved orderings from experiment (for eval second opption)
